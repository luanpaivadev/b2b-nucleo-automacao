package com.accenture.b2bautomacaostc.api.v1.controller;
...
@Slf4j
@RestController
@RequestMapping("/v1/checklist/stc/consultas")
public class ConsultaController {
    ...
    public ResponseEntity<List<Consulta>> findBySistema() {
        var consultas = consultasRepository.findBySistema("STC");
    ...
    public ResponseEntity<?> findBySistemaAndStatusProcessamento(StatusProcessamento statusProcessamento) {
        ...
        var consultas = consultasRepository.findBySistemaAndStatusProcessamento("STC", statusProcessamento);
        return ResponseEntity.ok(consultas);
    }
